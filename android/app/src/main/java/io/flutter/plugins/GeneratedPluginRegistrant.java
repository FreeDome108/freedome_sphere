...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.freedome_editor_comics.FreedomeEditorComicsPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin freedome_editor_comics, com.example.freedome_editor_comics.FreedomeEditorComicsPlugin", e);
    }
    try {
