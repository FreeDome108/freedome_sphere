// Обновления по монеткам реализовать с помощью очереди в RabbitMQ
// Топики в очереди имеют названия rateparser.${source}.${volume}, где source - источник курса, volume - объем торгов в USD(не путать с RateFetchParam["volume"])

global.VOLUMES=[0,1,2,5,10,20,50,100,200,500, 1000, 2000, 5000, 10000, 20000, 50000, 100000] //Возможные шаги обмена в USD

/*
    
    
//Список токенов:
const freeRateTokenSymbols: Record<string, string> = {};
...
export default freeRateTokenSymbols;
*/