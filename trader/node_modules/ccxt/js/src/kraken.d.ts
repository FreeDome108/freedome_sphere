import Exchange from 'ccxt/js/src/abstract/kraken.js';
import type { IndexType, Int, OrderSide, OrderType, OHLCV, Trade, Order, Balances, Str, Transaction, Ticker, OrderBook, Tickers, Strings, Currency, Market, TransferEntry, Num } from 'ccxt/js/src/base/types.js';
/**
 * @class kraken
 * @augments Exchange
...
export default class kraken extends Exchange {
    ...
    safeCurrency(currencyId: any, currency?: Currency): import("ccxt/js/src/base/types.js").CurrencyInterface;
