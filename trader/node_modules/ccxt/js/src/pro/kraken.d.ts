import krakenRest from 'ccxt/js/src/kraken.js';
import type { Int, OrderSide, OrderType, Str, OrderBook, Order, Trade, Ticker, OHLCV, Num } from 'ccxt/js/src/base/types.js';
