import kucoinfuturesRest from 'ccxt/js/src/kucoinfutures.js';
import type { Int, Str, OrderBook, Order, Trade, Ticker, Balances, Position } from 'ccxt/js/src/base/types.js';
