import bitmartRest from 'ccxt/js/src/bitmart.js';
import type { Int, Market, Str, Strings, OrderBook, Order, Trade, Ticker, Tickers, OHLCV, Position, Balances } from 'ccxt/js/src/base/types.js';
