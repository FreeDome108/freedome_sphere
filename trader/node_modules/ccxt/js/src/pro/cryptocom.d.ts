import cryptocomRest from 'ccxt/js/src/cryptocom.js';
import type { Int, OrderSide, OrderType, Str, Strings, OrderBook, Order, Trade, Ticker, OHLCV, Position, Balances, Num } from 'ccxt/js/src/base/types.js';
