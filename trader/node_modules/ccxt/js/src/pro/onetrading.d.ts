import onetradingRest from 'ccxt/js/src/onetrading.js';
import type { Int, Str, Strings, OrderBook, Order, Trade, Ticker, Tickers, OHLCV, Balances } from 'ccxt/js/src/base/types.js';
