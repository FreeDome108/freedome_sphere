import hitbtcRest from 'ccxt/js/src/hitbtc.js';
import type { Tickers, Int, OHLCV, OrderSide, OrderType, Strings, Num } from 'ccxt/js/src/base/types.js';
import Client from 'ccxt/js/src/base/ws/Client.js';
import { Str, OrderBook, Order, Trade, Ticker, Balances } from 'ccxt/js/src/base/types.js';
