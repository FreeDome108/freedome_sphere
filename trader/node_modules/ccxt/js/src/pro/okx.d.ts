import okxRest from 'ccxt/js/src/okx.js';
import type { Int, OrderSide, OrderType, Str, Strings, OrderBook, Order, Trade, Ticker, Tickers, OHLCV, Position, Balances, Num } from 'ccxt/js/src/base/types.js';
import Client from 'ccxt/js/src/base/ws/Client.js';
export default class okx extends okxRest {
    ...
    watchOHLCVForSymbols(symbolsAndTimeframes: string[][], since?: Int, limit?: Int, params?: {}): Promise<import("ccxt/js/src/base/types.js").Dictionary<import("ccxt/js/src/base/types.js").Dictionary<OHLCV[]>>>;
