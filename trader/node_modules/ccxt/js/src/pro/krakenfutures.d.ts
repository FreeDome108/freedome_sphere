import krakenfuturesRest from 'ccxt/js/src/krakenfutures.js';
import type { Int, Str, Strings, OrderBook, Order, Trade, Ticker, Tickers, Position, Balances } from 'ccxt/js/src/base/types.js';
