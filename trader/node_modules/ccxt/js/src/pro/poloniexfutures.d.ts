import poloniexfuturesRest from 'ccxt/js/src/poloniexfutures.js';
import type { Int, Str, OrderBook, Order, Trade, Ticker, Balances } from 'ccxt/js/src/base/types.js';
