import ascendexRest from 'ccxt/js/src/ascendex.js';
import type { Int, Str, OrderBook, Order, Trade, OHLCV, Balances } from 'ccxt/js/src/base/types.js';
...
export default class ascendex extends ascendexRest {
    ...
    fetchOrderBookSnapshot(symbol: string, limit?: Int, params?: {}): Promise<import("ccxt/js/src/base/ws/OrderBook.js").OrderBook>;
