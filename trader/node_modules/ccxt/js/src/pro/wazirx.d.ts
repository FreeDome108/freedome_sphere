import wazirxRest from 'ccxt/js/src/wazirx.js';
import type { Int, OHLCV, Str, Strings, OrderBook, Order, Trade, Ticker, Tickers, Balances } from 'ccxt/js/src/base/types.js';
