import * as ut from 'ccxt/js/src/static_dependencies/noble-curves/abstract/utils.js';
import { FHash, Hex } from 'ccxt/js/src/static_dependencies/noble-curves/abstract/utils.js';
import { Group, GroupConstructor, BasicCurve, AffinePoint } from 'ccxt/js/src/static_dependencies/noble-curves/abstract/curve.js';
...
declare function validateOpts(curve: CurveType): Readonly<{
    ...
    readonly Fp: import("ccxt/js/src/static_dependencies/noble-curves/abstract/modular.js").Field<bigint>;
    readonly n: bigint;
    readonly h: bigint;
