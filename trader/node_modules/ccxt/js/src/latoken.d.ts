import Exchange from 'ccxt/js/src/abstract/latoken.js';
import type { TransferEntry, Balances, Currency, Int, Market, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, Transaction, Num } from 'ccxt/js/src/base/types.js';
/**
 * @class latoken
 * @augments Exchange
 */
