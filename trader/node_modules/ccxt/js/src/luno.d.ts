import Exchange from 'ccxt/js/src/abstract/luno.js';
import type { Balances, Currency, Int, Market, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, OHLCV, Num, Account } from 'ccxt/js/src/base/types.js';
/**
 * @class luno
 * @augments Exchange
 */
