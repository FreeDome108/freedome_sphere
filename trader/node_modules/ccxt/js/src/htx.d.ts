import Exchange from 'ccxt/js/src/abstract/htx.js';
import type { BorrowRate, TransferEntry, Int, OrderSide, OrderType, Order, OHLCV, Trade, FundingRateHistory, Balances, Str, Transaction, Ticker, OrderBook, Tickers, OrderRequest, Strings, Market, Currency, Num, Account } from 'ccxt/js/src/base/types.js';
/**
 * @class huobi
 * @augments Exchange
 */
export default class htx extends Exchange {
    ...
    fetchOpenInterestHistory(symbol: string, timeframe?: string, since?: Int, limit?: Int, params?: {}): Promise<import("ccxt/js/src/base/types.js").OpenInterest[]>;
    fetchOpenInterest(symbol: string, params?: {}): Promise<import("ccxt/js/src/base/types.js").OpenInterest>;
    parseOpenInterest(interest: any, market?: Market): import("ccxt/js/src/base/types.js").OpenInterest;
    ...
    fetchLiquidations(symbol: string, since?: Int, limit?: Int, params?: {}): Promise<import("ccxt/js/src/base/types.js").Liquidation[]>;
    parseLiquidation(liquidation: any, market?: Market): import("ccxt/js/src/base/types.js").Liquidation;
