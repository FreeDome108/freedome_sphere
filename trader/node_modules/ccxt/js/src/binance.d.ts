import Exchange from 'ccxt/js/src/abstract/binance.js';
import type { TransferEntry, Int, OrderSide, Balances, OrderType, Trade, OHLCV, Order, FundingRateHistory, OpenInterest, Liquidation, OrderRequest, Str, Transaction, Ticker, OrderBook, Tickers, Market, Greeks, Strings, Currency, MarketInterface, MarginMode, MarginModes, Leverage, Leverages, Num } from 'ccxt/js/src/base/types.js';
/**
 * @class binance
 * @augments Exchange
 */
export default class binance extends Exchange {
    ...
    parseBalanceHelper(entry: any): import("ccxt/js/src/base/types.js").BalanceAccount;
    ...
    fetchBidsAsks(symbols?: Strings, params?: {}): Promise<import("ccxt/js/src/base/types.js").Dictionary<Ticker>>;
    fetchLastPrices(symbols?: Strings, params?: {}): Promise<import("ccxt/js/src/base/types.js").LastPrices>;
    ...
    fetchPosition(symbol: string, params?: {}): Promise<import("ccxt/js/src/base/types.js").Position>;
    fetchOptionPositions(symbols?: Strings, params?: {}): Promise<import("ccxt/js/src/base/types.js").Position[]>;
    parsePosition(position: any, market?: Market): import("ccxt/js/src/base/types.js").Position;
    fetchPositions(symbols?: Strings, params?: {}): Promise<import("ccxt/js/src/base/types.js").Position[]>;
    fetchAccountPositions(symbols?: Strings, params?: {}): Promise<import("ccxt/js/src/base/types.js").Position[]>;
    fetchPositionsRisk(symbols?: Strings, params?: {}): Promise<import("ccxt/js/src/base/types.js").Position[]>;
    fetchFundingHistory(symbol?: Str, since?: Int, limit?: Int, params?: {}): Promise<import("ccxt/js/src/base/types.js").FundingHistory[]>;
    ...
    getExceptionsByUrl(url: any, exactOrBroad: any): import("ccxt/js/src/base/types.js").Dictionary<any>;
