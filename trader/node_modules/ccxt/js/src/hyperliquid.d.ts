import Exchange from 'ccxt/js/src/abstract/hyperliquid.js';
import type { Market, TransferEntry, Balances, Int, OrderBook, OHLCV, Str, FundingRateHistory, Order, OrderType, OrderSide, Trade, Strings, Position, OrderRequest, Dict, Num } from 'ccxt/js/src/base/types.js';
/**
 * @class hyperliquid
 * @augments Exchange
 */
