import Exchange from 'ccxt/js/src/abstract/btcmarkets.js';
import type { Balances, Currency, Int, Market, Num, OHLCV, Order, OrderBook, OrderSide, OrderType, Str, Ticker, Trade, Transaction } from 'ccxt/js/src/base/types.js';
/**
 * @class btcmarkets
 * @augments Exchange
 */
