import Exchange from 'ccxt/js/src/abstract/phemex.js';
import type { TransferEntry, Balances, Currency, FundingHistory, FundingRateHistory, Int, Market, Num, OHLCV, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, Transaction } from 'ccxt/js/src/base/types.js';
/**
 * @class phemex
 * @augments Exchange
 */
export default class phemex extends Exchange {
    ...
    parseSwapMarket(market: any): import("ccxt/js/src/base/types.js").MarketInterface;
    parseSpotMarket(market: any): import("ccxt/js/src/base/types.js").MarketInterface;
