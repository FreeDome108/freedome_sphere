import Exchange from 'ccxt/js/src/abstract/blockchaincom.js';
import type { Balances, Currency, Int, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, Transaction } from 'ccxt/js/src/base/types.js';
/**
 * @class blockchaincom
 * @augments Exchange
 */
