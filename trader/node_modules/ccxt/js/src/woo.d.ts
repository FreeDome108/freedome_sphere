import Exchange from 'ccxt/js/src/abstract/woo.js';
import type { TransferEntry, Balances, Currency, FundingRateHistory, Int, Market, Num, OHLCV, Order, OrderBook, OrderSide, OrderType, Str, Strings, Trade, Transaction, Leverage, Account } from 'ccxt/js/src/base/types.js';
/**
 * @class woo
 * @augments Exchange
 */
export default class woo extends Exchange {
    ...
    fetchPosition(symbol?: Str, params?: {}): Promise<import("ccxt/js/src/base/types.js").Position>;
