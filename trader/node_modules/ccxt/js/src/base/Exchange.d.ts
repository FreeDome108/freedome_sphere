import * as functions from 'ccxt/js/src/base/functions.js';
import { // eslint-disable-line object-curly-newline
ExchangeError, AuthenticationError, DDoSProtection, RequestTimeout, ExchangeNotAvailable, RateLimitExceeded } from "ccxt/js/src/base/errors.js";
import WsClient from 'ccxt/js/src/base/ws/WsClient.js';
import { OrderBook as WsOrderBook, IndexedOrderBook, CountedOrderBook } from 'ccxt/js/src/base/ws/OrderBook.js';
import type { Market, Trade, Ticker, OHLCV, OHLCVC, Order, OrderBook, Balance, Balances, Dictionary, Transaction, DepositAddressResponse, Currency, MinMax, IndexType, Int, OrderType, OrderSide, Position, FundingRate, DepositWithdrawFeeNetwork, LedgerEntry, BorrowInterest, OpenInterest, LeverageTier, TransferEntry, FundingRateHistory, Liquidation, FundingHistory, OrderRequest, MarginMode, Tickers, Greeks, Str, Num, MarketInterface, CurrencyInterface, BalanceAccount, MarginModes, MarketType, Leverage, Leverages, LastPrice, LastPrices, Account } from 'ccxt/js/src/base/types.js';
export type { Market, Trade, Fee, Ticker, OHLCV, OHLCVC, Order, OrderBook, Balance, Balances, Dictionary, Transaction, DepositAddressResponse, Currency, MinMax, IndexType, Int, OrderType, OrderSide, Position, FundingRateHistory, Liquidation, FundingHistory, Greeks, Leverage, Leverages, Str } from 'ccxt/js/src/base/types.js';
import { ArrayCache, ArrayCacheByTimestamp } from 'ccxt/js/src/base/ws/Cache.js';
import { OrderBook as Ob } from 'ccxt/js/src/base/ws/OrderBook.js';
/**
 * @class Exchange
 */
export default class Exchange {
    ...
    binaryConcat: typeof import("ccxt/js/src/static_dependencies/noble-curves/abstract/utils.js").concatBytes;
    hash: (request: import("ccxt/js/src/static_dependencies/noble-hashes/utils.js").Input, hash: {
        (message: import("ccxt/js/src/static_dependencies/noble-hashes/utils.js").Input): Uint8Array;
        outputLen: number;
        blockLen: number;
        create(): import("ccxt/js/src/static_dependencies/noble-hashes/utils.js").Hash<import("ccxt/js/src/static_dependencies/noble-hashes/utils.js").Hash<any>>;
    }, digest?: "binary" | "hex" | "base64") => any;
    arrayConcat: (a: any, b: any) => any;
    encode: (str: string) => Uint8Array;
    urlencode: (object: any) => string;
    hmac: (request: import("ccxt/js/src/static_dependencies/noble-hashes/utils.js").Input, secret: import("ccxt/js/src/static_dependencies/noble-hashes/utils.js").Input, hash: {
        (message: import("ccxt/js/src/static_dependencies/noble-hashes/utils.js").Input): Uint8Array;
        outputLen: number;
        blockLen: number;
        create(): import("ccxt/js/src/static_dependencies/noble-hashes/utils.js").Hash<import("ccxt/js/src/static_dependencies/noble-hashes/utils.js").Hash<any>>;
    ...
    spawn(method: any, ...args: any[]): import("ccxt/js/src/base/ws/Future.js").FutureInterface;
    ...
    watchMultiple(url: string, messageHashes: string[], message?: any, subscribeHashes?: any, subscription?: any): import("ccxt/js/src/base/ws/Future.js").FutureInterface;
