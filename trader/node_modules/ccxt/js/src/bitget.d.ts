import Exchange from 'ccxt/js/src/abstract/bitget.js';
import type { Int, OrderSide, OrderType, Trade, OHLCV, Order, FundingRateHistory, OrderRequest, FundingHistory, Balances, Str, Transaction, Ticker, OrderBook, Tickers, Market, Strings, Currency, Position, Liquidation, TransferEntry, Leverage, MarginMode, Num } from 'ccxt/js/src/base/types.js';
/**
 * @class bitget
 * @augments Exchange
 */
export default class bitget extends Exchange {
    ...
    fetchMarketsByType(type: any, params?: {}): Promise<import("ccxt/js/src/base/types.js").MarketInterface[]>;
