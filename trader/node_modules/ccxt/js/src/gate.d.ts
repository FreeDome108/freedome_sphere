import Exchange from 'ccxt/js/src/abstract/gate.js';
import type { Int, OrderSide, OrderType, OHLCV, Trade, FundingRateHistory, OpenInterest, Order, Balances, OrderRequest, FundingHistory, Str, Transaction, Ticker, OrderBook, Tickers, Greeks, Strings, Market, Currency, MarketInterface, TransferEntry, Leverage, Leverages, Num } from 'ccxt/js/src/base/types.js';
/**
 * @class gate
 * @augments Exchange
 */
export default class gate extends Exchange {
    ...
    fetchMyLiquidations(symbol?: Str, since?: Int, limit?: Int, params?: {}): Promise<import("ccxt/js/src/base/types.js").Liquidation[]>;
