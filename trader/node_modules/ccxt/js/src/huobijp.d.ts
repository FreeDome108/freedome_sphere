import Exchange from 'ccxt/js/src/abstract/huobijp.js';
import type { Account, Balances, Currency, Int, Market, Num, OHLCV, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, Transaction } from 'ccxt/js/src/base/types.js';
/**
 * @class huobijp
 * @augments Exchange
 */
