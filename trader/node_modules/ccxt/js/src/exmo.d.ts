import Exchange from 'ccxt/js/src/abstract/exmo.js';
import type { Dictionary, Int, Order, OrderSide, OrderType, Trade, OrderBook, OHLCV, Balances, Str, Transaction, Ticker, Tickers, Strings, Market, Currency, Num } from 'ccxt/js/src/base/types.js';
/**
 * @class exmo
 * @augments Exchange
 */
