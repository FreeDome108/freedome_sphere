import Exchange from 'ccxt/js/src/abstract/krakenfutures.js';
import type { TransferEntry, Int, OrderSide, OrderType, OHLCV, Trade, FundingRateHistory, OrderRequest, Order, Balances, Str, Ticker, OrderBook, Tickers, Strings, Market, Currency, Leverage, Leverages, Num } from 'ccxt/js/src/base/types.js';
/**
 * @class krakenfutures
 * @augments Exchange
 */
