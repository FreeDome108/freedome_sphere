import Exchange from 'ccxt/js/src/abstract/bybit.js';
import type { Int, OrderSide, OrderType, Trade, Order, OHLCV, FundingRateHistory, OpenInterest, OrderRequest, Balances, Str, Transaction, Ticker, OrderBook, Tickers, Greeks, Strings, Market, Currency, MarketInterface, TransferEntry, Liquidation, Leverage, Num } from 'ccxt/js/src/base/types.js';
/**
 * @class bybit
 * @augments Exchange
 */
export default class bybit extends Exchange {
    ...
    fetchUsdcPositions(symbols?: Strings, params?: {}): Promise<import("ccxt/js/src/base/types.js").Position[]>;
