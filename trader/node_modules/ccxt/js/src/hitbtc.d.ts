import Exchange from 'ccxt/js/src/abstract/hitbtc.js';
import type { TransferEntry, Int, OrderSide, OrderType, FundingRateHistory, OHLCV, Ticker, Order, OrderBook, Dictionary, Position, Str, Trade, Balances, Transaction, MarginMode, Tickers, Strings, Market, Currency, MarginModes, Leverage, Num } from 'ccxt/js/src/base/types.js';
/**
 * @class hitbtc
 * @augments Exchange
 */
