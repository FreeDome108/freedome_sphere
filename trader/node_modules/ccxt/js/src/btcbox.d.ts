import Exchange from 'ccxt/js/src/abstract/btcbox.js';
import type { Balances, Int, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Ticker, Trade } from 'ccxt/js/src/base/types.js';
/**
 * @class btcbox
 * @augments Exchange
 */
