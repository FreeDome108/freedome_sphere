import Exchange from 'ccxt/js/src/abstract/bitstamp.js';
...
export default class bitstamp extends Exchange {
    ...
    getMarketFromTrade(trade: any): import("ccxt/js/src/base/types.js").MarketInterface;
    ...
    parseLedgerEntry(item: any, currency?: Currency): {
        ...
        after: any;
        status: string;
        fee: import("ccxt/js/src/base/types.js").FeeInterface;
    } | {
        id: string;
        info: any;
        timestamp: number;
