import Exchange from 'ccxt/js/src/abstract/coinmetro.js';
import { Balances, Currency, IndexType, Int, Market, Num, OHLCV, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade } from 'ccxt/js/src/base/types.js';
/**
 * @class coinmetro
 * @augments Exchange
 */
export default class coinmetro extends Exchange {
    ...
    parseLedgerEntry(item: any, currency?: Currency): {
        ...
        status: string;
        fee: any;
        info: import("ccxt/js/src/base/types.js").Dictionary<any>;
    };
