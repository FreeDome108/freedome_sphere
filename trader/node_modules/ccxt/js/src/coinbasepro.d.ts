import Exchange from 'ccxt/js/src/abstract/coinbasepro.js';
import type { Int, OrderSide, OrderType, Trade, OHLCV, Order, Balances, Str, Transaction, Ticker, OrderBook, Tickers, Strings, Market, Currency, Num, Account } from 'ccxt/js/src/base/types.js';
/**
 * @class coinbasepro
 * @augments Exchange
 */
