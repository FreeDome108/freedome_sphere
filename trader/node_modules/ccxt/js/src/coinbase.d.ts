import Exchange from 'ccxt/js/src/abstract/coinbase.js';
import type { Int, OrderSide, OrderType, Order, Trade, OHLCV, Ticker, OrderBook, Str, Transaction, Balances, Tickers, Strings, Market, Currency, Num, Account } from 'ccxt/js/src/base/types.js';
/**
 * @class coinbase
 * @augments Exchange
 */
export default class coinbase extends Exchange {
    ...
    fetchCurrenciesFromCache(params?: {}): Promise<import("ccxt/js/src/base/types.js").Dictionary<any>>;
    fetchCurrencies(params?: {}): Promise<{}>;
    fetchTickers(symbols?: Strings, params?: {}): Promise<Tickers>;
    fetchTickersV2(symbols?: Strings, params?: {}): Promise<import("ccxt/js/src/base/types.js").Dictionary<Ticker>>;
    fetchTickersV3(symbols?: Strings, params?: {}): Promise<import("ccxt/js/src/base/types.js").Dictionary<Ticker>>;
    ...
    cancelOrder(id: string, symbol?: Str, params?: {}): Promise<import("ccxt/js/src/base/types.js").Dictionary<any>>;
