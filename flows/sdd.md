...
**Output**: `flows/sdd-[name]/02-specifications.md` + `flows/sdd-[name]/README.md`
...
- **Marketing README.md** (bilingual: Chinese & English)
...
- [ ] Marketing README.md created (bilingual)
